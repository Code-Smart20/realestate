...
const SignUp = () => {
  ...
  /*const handleGoogleSignUp = () => {
    try {
      ...
      toast.error("we cant sign u up for now")
    }
  }*/
  ...
  const handleSignUp = async (e) => {
    ...
    try {
      ...
      //updating usersname
      updateProfile(auth.userCredentials, {
        displayName: FullName,
      })

      // creating a database on signUp
      const user = userCredentials.user;
      ...
      // navigating to Homepage aftern Signup
      navigate("/")
      */
      ...
      <div className="authentication">
        ...
        <div className="authentication__container container">
          ...
          <div className="authentication__img">
            <img className='authentication__key'
              src={key}
              alt="login key" />
          </div>
            ...
            <form onSubmit={handleSignUp}>
              ...
              <div className='password__wrapper'>
                ...
                <p className="showpassword"
                  ...
                  {showPassword ? <AiFillEyeInvisible className='eyes'
                    size={30} /> : <AiOutlineEye className='eyes'
                    size={30} />}
                </p>
              ...
              <button
                className='btn btn-primary form__input google'
